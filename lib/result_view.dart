...
import 'package:kodepos_sample/controller/kodepos_controller.dart';
import 'package:kodepos_sample/models/kodepos_model.dart';
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("Subdistrict : ${data[index].subdistrict}"),
                              Text("Urban : ${data[index].urban}"),
                              Text("Postal Code : ${data[index].postalCode}",
                                  style: const TextStyle(
                                      fontWeight: FontWeight.bold))
                            ],
                          ),
